...
abstract class ExeciseService {
  static Future<BaseTextBookExercise<ChoicesExerciseData>>
      getChoicesExerciseData() async {
    final String response =
        await rootBundle.loadString('assets/jsons/choices.json');
    final data = await json.decode(response);
    final baseExerciseModel =
        BaseTextBookExercise<ChoicesExerciseData>.fromJson(data);
