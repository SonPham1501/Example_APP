...
class FillInTheBlank extends StatelessWidget {
  ...
  ListView _listAnwser() => ListView.separated(
    ...
    separatorBuilder: (BuildContext context, int index) {
      return index == items.length - 1 ? const SizedBox.shrink() : const SizedBox(height: 20);
    },
  );
  ...
  Text _content() => Text(
    ...
    style: const TextStyle(color: Colors.blue, fontSize: 18, fontWeight: FontWeight.w500, height: 1.2),
  );
